...
add_shortcode('contact_phone_icon', function () {
    if (get_field('contact_phone', 'option')) {
        return '<a href="tel:' . parse_phone(get_field('contact_phone', 'option')) . '"><i class="fas fa-phone"></i> ' . get_field('contact_phone', 'option') . '</a>';
    }
    return;
});
...
add_shortcode('contact_email_icon', function () {
    if (get_field('contact_email', 'option')) {
        return '<a href="mailto:' . get_field('contact_email', 'option') . '"><i class="fas fa-envelope"></i> ' . get_field('contact_email', 'option') . '</a>';
    }
    return;
});
