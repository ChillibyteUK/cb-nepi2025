...
<head>
    ...
    <link rel="preload"
        href="<?= get_stylesheet_directory_uri() ?>/fonts/montserrat-v29-latin-500.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= get_stylesheet_directory_uri() ?>/fonts/montserrat-v29-latin-800.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "North East Property Investment Ltd",
            "url": "https://nepi.uk/",
            "logo": "---",
            "description": "---",
            "address": {
                "@type": "PostalAddress",
                "streetAddress": "11 Riverside Studios, Amethyst Rd",
                "addressLocality": "Newcastle Upon Tyne",
                "addressRegion": "Tyne and Wear",
                "postalCode": "NE4 7YL",
                "addressCountry": "GB"
            },
            "telephone": "+44 (0) 191 716 1670",
            "email": "info@nepi.uk"
        }
    </script>
        ...
        <nav class="navbar navbar-expand-lg p-0">
            <div class="container-xl pt-4 nav-top align-items-center">
                <div class="top-nav">
                    ...
                    <div class="top-nav__email"><?= do_shortcode('[contact_email]') ?></div>
                </div>
